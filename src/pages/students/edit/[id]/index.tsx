      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <FormControl
            ...
            alignItems="center"
            mb="4"
            isInvalid={!!formik.errors?.admission_status}
          >
            <FormLabel htmlFor="switch-admission_status">Admission Status</FormLabel>
            <Switch
              id="switch-admission_status"
              name="admission_status"
              onChange={formik.handleChange}
              value={formik.values?.admission_status ? 1 : 0}
            />
            {formik.errors?.admission_status && <FormErrorMessage>{formik.errors?.admission_status}</FormErrorMessage>}
          </FormControl>
          ...
          <FormControl
            ...
            alignItems="center"
            mb="4"
            isInvalid={!!formik.errors?.enrollment_status}
          >
            <FormLabel htmlFor="switch-enrollment_status">Enrollment Status</FormLabel>
            <Switch
              id="switch-enrollment_status"
              name="enrollment_status"
              onChange={formik.handleChange}
              value={formik.values?.enrollment_status ? 1 : 0}
            />
            {formik.errors?.enrollment_status && (
              <FormErrorMessage>{formik.errors?.enrollment_status}</FormErrorMessage>
            )}
          </FormControl>
          ...
          <FormControl
            ...
            alignItems="center"
            mb="4"
            isInvalid={!!formik.errors?.fee_status}
          >
            <FormLabel htmlFor="switch-fee_status">Fee Status</FormLabel>
            <Switch
              id="switch-fee_status"
              name="fee_status"
              onChange={formik.handleChange}
              value={formik.values?.fee_status ? 1 : 0}
            />
            {formik.errors?.fee_status && <FormErrorMessage>{formik.errors?.fee_status}</FormErrorMessage>}
          </FormControl>

          <TextInput
            error={formik.errors.parent_info}
            label={'Parent Info'}
            props={{
              name: 'parent_info',
              placeholder: 'Parent Info',
              value: formik.values?.parent_info,
              onChange: formik.handleChange,
            }}
          />
