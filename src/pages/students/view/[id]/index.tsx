...
import { TimetableListPage } from 'pages/timetables';
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Admission Status" text={data?.admission_status} />

                <FormListItem label="Enrollment Status" text={data?.enrollment_status} />

                <FormListItem label="Fee Status" text={data?.fee_status} />

                <FormListItem label="Parent Info" text={data?.parent_info} />
