...
export function StudentListPage(props: StudentListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getStudents({
        relations: ['school', 'examination.count', 'timetable.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['name.contains', 'parent_info.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'academic_record', header: 'academic_record', accessorKey: 'academic_record' },
    { id: 'behavior_record', header: 'behavior_record', accessorKey: 'behavior_record' },
    { id: 'health_record', header: 'health_record', accessorKey: 'health_record' },
    { id: 'admission_status', header: 'Admission Status', accessorKey: 'admission_status' },
    { id: 'enrollment_status', header: 'Enrollment Status', accessorKey: 'enrollment_status' },
    { id: 'fee_status', header: 'Fee Status', accessorKey: 'fee_status' },
    { id: 'parent_info', header: 'Parent Info', accessorKey: 'parent_info' },
    ...
    hasAccess('examination', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('timetable', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'timetable',
          header: 'Timetable',
          accessorKey: 'timetable',
          cell: ({ row: { original: record } }: any) => record?._count?.timetable,
        }
      : null,
